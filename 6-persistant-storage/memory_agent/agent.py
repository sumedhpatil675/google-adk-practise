...
def update_reminder(index:int,update_text:str,tool_context:ToolContext)->dict:
    ...
    ## Updating the reminder (adjusting for 0-based indices)
...
memory_agent = Agent(
    ...
    instruction="""
    You are a friendly reminder assistant that remembers users accross conversations.
    ...
    **REMINDER MANAGEMENT GUIDELINES:**
    ...
    Remember to explain that you can remeber their information across conversations.
