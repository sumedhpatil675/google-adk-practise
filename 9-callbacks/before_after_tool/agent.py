...
This example demonstrates using tool callbacks to modify tool behaviour
...
def before_tool_callback(
    ...
    print("[Callback] Processing with normal tool call")
    return None
...
root_agent = LlmAgent(
    ...
    Your job is to:
        ...
        - When reporting a captial, display it EXACTLY as returned by the tool

    Examples:
    - "What is the captial of France?" -> Use get_capital_city with country="France"
