...
customer_service_agent = Agent(
    ...
    Your role is to help users with thier questions and direct them to the apporopriate specialized agent.
    ...
    **Interaction History:**
    ...
    When the user hasnt purchased any courses yet, encourage them to explore the AI Marketing Platform.
    When the user has purchased courses, offer support for those specific courses.

    When users express dissatisfication or ask for a refund:
