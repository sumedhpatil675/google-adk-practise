...
It uses a parallel agent for system information gathering and a sequential pipeline for the 
overall flow.
...
# ----- 2. Create Sequential Pipeline to gather info in paralll, then synthesize
