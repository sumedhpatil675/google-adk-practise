...
stock_analyst = Agent(
    ...
    instruction="""
    You are a helpful stock market assistant that help users track thier stocks of interest.
    ...
    3. If a stock price couldnt be fetched, mention this in your response
